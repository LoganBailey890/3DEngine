...
int main(int argc, char** argv)
{
	...
	//position
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float),(GLbyte*)NULL);
	glEnableVertexAttribArray(0);
	//color
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6* sizeof(float),(GLbyte*)(3*sizeof(float)));
